...
import 'package:prok_mobile/screens/teacher/attendance_insights_screen.dart';
import 'package:prok_mobile/screens/teacher/teacher_profile_screen.dart';
class AppRouter {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case AppRoutes.teacherClassDetails: page = const ClassDetailsScreen(); break;
      case AppRoutes.teacherMarkAttendance: page = const MarkAttendanceScreen(); break;
      case AppRoutes.teacherAttendanceHistory: page = const AttendanceHistoryScreen(); break;
      case AppRoutes.teacherAttendanceInsights: page = const AttendanceInsightsScreen(); break;
      case AppRoutes.teacherProfile: page = const TeacherProfileScreen(); break;
