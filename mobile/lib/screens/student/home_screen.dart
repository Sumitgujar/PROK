    ...
    return Scaffold(
                    ...
                    child: ListView(
                      ...
                      children: [
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'Explain my data and suggest next steps',
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    const Text('Overall'),
                                    Text(
                                      '${_d?['attendance']?['overall_percentage'] ?? 0}%',
                        ...
                        if ((_d?['courses']?['recommendations'] as List?)?.isNotEmpty == true) ...[
                          ...
                          const SizedBox(height: 8),
                          ...(_d!['courses']['recommendations'] as List).take(3).map(
                                (c) => Card(
                        ...
                        Row(
                          children: [
                            Expanded(
                              child: _QuickBtn(label: 'Profile', icon: Icons.person_outline, route: AppRoutes.studentProfile),
                            ),
                            const SizedBox(width: 10),
                            Expanded(
                              child: _QuickBtn(label: 'Ask PROK', icon: Icons.auto_awesome, route: AppRoutes.studentAskProk),
                            ),
                          ],
                        ),
                      ],
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          ...
          BottomNavigationBarItem(icon: Icon(Icons.auto_awesome), label: 'Ask PROK'),
...
class _MiniCard extends StatelessWidget {
  ...
  const _MiniCard({required this.title, required this.value, required this.subtitle, required this.icon, required this.color, required this.onTap});
  @override
